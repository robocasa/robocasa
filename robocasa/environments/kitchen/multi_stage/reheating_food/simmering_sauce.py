...
class SimmeringSauce(Kitchen):
    ...
    def _setup_kitchen_references(self):
        ...
        self.counter = self.register_fixture_ref("counter", dict(id=FixtureType.COUNTER, ref=self.stove, size=(0.5, 0.4)))
    ...
    def get_ep_meta(self):
        ...
        ep_meta["lang"] = f"Place the pan on the {self.knob.replace('_', ' ')} burner on the stove. Then place the tomato and the onion in the pan and turn on the {self.knob.replace('_', ' ')} burner."
        return ep_meta
