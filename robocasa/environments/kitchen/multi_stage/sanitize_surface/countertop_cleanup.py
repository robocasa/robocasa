...
class CountertopCleanup(Kitchen):
    ...
    def _setup_kitchen_references(self):
        ...
        self.drawer = self.register_fixture_ref("drawer", dict(id=FixtureType.TOP_DRAWER, ref=self.cab))
    ...
    def get_ep_meta(self):
        ...
        ep_meta["lang"] = f"Pick  the fruit and vegetable from the counter and place it in the cabinet. Then, open the drawer and pick the cleaner and sponge from the drawer and place it on the counter."
        return ep_meta
    ...
    def _check_success(self):
        ...
        objs_on_counter = OU.check_obj_fixture_contact(self, "obj", self.counter) and OU.check_obj_fixture_contact(self, "obj2", self.counter)
        objs_inside_cab = OU.obj_inside_of(self, "obj3", self.cab) and OU.obj_inside_of(self, "obj4", self.cab)
