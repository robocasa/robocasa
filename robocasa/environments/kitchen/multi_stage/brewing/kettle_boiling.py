...
class KettleBoiling(Kitchen):
    def _setup_kitchen_references(self):
        ...
        self.counter = self.register_fixture_ref("counter", dict(id=FixtureType.COUNTER, ref=self.stove, size=(0.2, 0.2)))
    ...
    def get_ep_meta(self):
        ...
        ep_meta["lang"] = f"Pick the kettle from the counter and place it on a stove burner. Then, turn the burner on"
        return ep_meta
    ...
    def _check_success(self):
        ...
        kettle_pos = np.array(self.sim.data.body_xpos[self.obj_body_id[kettle.name]])[0:2]
