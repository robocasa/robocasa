...
class DryDrinkware(Kitchen):
    ...
    def get_ep_meta(self):  
        ...
        ep_meta["lang"] = "A wet mug is on the counter and need to " \
            "be dried. Pick it up and place it upside down in the open cabinet."
        return ep_meta
    ...
    def _check_success(self):
        ...
        return OU.gripper_obj_far(self, obj_name="mug") and np.abs(mug_rot[2]) > 3 and \
            OU.check_obj_fixture_contact(self, "mug", self.cab)