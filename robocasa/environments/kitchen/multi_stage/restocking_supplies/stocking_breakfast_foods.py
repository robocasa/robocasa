...
class StockingBreakfastFoods(Kitchen):
    def __init__(self, cab_id1=FixtureType.CABINET_TOP, cab_id2=FixtureType.CABINET_TOP, *args, **kwargs):
    ...
    def _setup_kitchen_references(self):
        ...
        if "cab2" in self.fixture_refs:
            ...
            self.counter = self.register_fixture_ref("counter", dict(id=FixtureType.COUNTER, ref=self.cab1))
            self.counter2 = self.register_fixture_ref("counter2", dict(id=FixtureType.COUNTER, ref=self.cab2))
    ...
    def get_ep_meta(self):
        ...
        ep_meta["lang"] = f"pick the {obj_name_1} and {obj_name_2} from the counter and place it in the closest cabinet to them."
