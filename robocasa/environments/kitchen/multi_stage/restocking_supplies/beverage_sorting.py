...
class BeverageSorting(Kitchen):
    ...
    def _setup_kitchen_references(self):
        ...
        self.cab1 = self.register_fixture_ref("cabinet1", dict(id=FixtureType.CABINET_TOP))
    ...
    def get_ep_meta(self):
        ...
        ep_meta["lang"] = "Sort all alcoholic drinks to one cabinet, and non-alcoholic drinks to the other."
        return ep_meta
    ...
    def _check_success(self):
        ...
        for (c1, c2) in [(self.cab1, self.cab2), (self.cab2, self.cab1)]:
            if OU.obj_inside_of(self, "alcohol1", c1) and OU.obj_inside_of(self, "alcohol2", c1):
                if OU.obj_inside_of(self, "non_alcohol1", c2) and OU.obj_inside_of(self, "non_alcohol2", c2):
                    return True
