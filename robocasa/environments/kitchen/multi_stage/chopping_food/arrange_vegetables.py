...
class ArrangeVegetables(Kitchen):
    ...
    def _check_success(self):
        vegetable1_cutting_board_contact = OU.check_obj_in_receptacle(self, "vegetable1", "cutting_board")
        vegetable2_cutting_board_contact = OU.check_obj_in_receptacle(self, "vegetable2", "cutting_board")
        gripper_obj_far = OU.gripper_obj_far(self, obj_name="cutting_board")

        return vegetable1_cutting_board_contact and vegetable2_cutting_board_contact and gripper_obj_far