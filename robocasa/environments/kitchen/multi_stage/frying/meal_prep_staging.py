...
class MealPrepStaging(Kitchen):
    ...
    def _setup_kitchen_references(self):
        ...
        self.counter = self.register_fixture_ref("counter", dict(id=FixtureType.COUNTER, ref=self.stove, size=(0.3, 0.2)))
    ...
    def get_ep_meta(self):
        ...
        ep_meta["lang"] = f"pick place both pans onto different burners. Then, place the {obj_name_1} and the {obj_name_2} on different pans"
        return ep_meta
    ...
    def _check_success(self):
        ...
        food_on_pans = (vegetable_on_pan1 and meat_on_pan2) or (vegetable_on_pan2 and meat_on_pan1)
