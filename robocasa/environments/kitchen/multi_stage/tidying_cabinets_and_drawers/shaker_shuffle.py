...
class ShakerShuffle(ManipulateDrawer):
    ...
    def _setup_kitchen_references(self):
        ...
        self.cab = self.register_fixture_ref("cab", dict(id=FixtureType.CABINET_TOP, ref=self.drawer))

    def get_ep_meta(self):
        ep_meta = super().get_ep_meta()
        ep_meta["lang"] = "Pick place the shaker into the drawer. Then, Close the cabinet."
        return ep_meta
    ...
    def _check_success(self):
        shaker_in_drawer = OU.obj_inside_of(self, "shaker1", self.drawer) and OU.obj_inside_of(self, "shaker2", self.drawer) and not OU.obj_inside_of(self, "condiment", self.drawer)
