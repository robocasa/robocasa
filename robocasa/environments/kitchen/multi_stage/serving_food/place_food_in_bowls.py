...
class PlaceFoodInBowls(Kitchen):
    ...
    def get_ep_meta(self):
        ...
        ep_meta["lang"] = f"Pick both bowls and place them on the counter. Then pick the {food1} and place it in one bowl and pick the {food2} and place it in the other bowl."
        return ep_meta
    ...
    def _check_success(self):
        ...
        receptacles_on_counter = OU.check_obj_fixture_contact(self, "receptacle1", self.counter) and \
                                OU.check_obj_fixture_contact(self, "receptacle2", self.counter)


        food_in_bowls = (food1_in_receptacle1 and food2_in_receptacle2) or (food1_in_receptacle2 and food2_in_receptacle1)

        return gripper_food1_far and gripper_food2_far and food_in_bowls and receptacles_on_counter
