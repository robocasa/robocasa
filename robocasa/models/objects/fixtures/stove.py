...
STOVE_LOCATIONS = ["rear_left", "rear_center", "rear_right", "front_left", "front_center", "front_right", "center"]
...
class Stove(Fixture):
    ...
    def get_reset_regions(self, env, locs=None):
        ...
        for location in locs:
            site = self.worldbody.find("./body/body/site[@name='{}burner_{}_place_site']".format(self.naming_prefix, location))
            if site is None:
                site = self.worldbody.find("./body/body/site[@name='{}burner_on_{}']".format(self.naming_prefix, location))
            if site is None:
                continue
    ...
    def knob_joints(self):
        if self._knob_joints is None:
            self._knob_joints = {}
            for location in STOVE_LOCATIONS:
                joint = self.worldbody.find("./body/body/body/joint[@name='{}knob_{}_joint']".format(self.naming_prefix, location))
