...
class Sink(Fixture):
    ...
    def update_state(self, env):
        ...
        site_id = env.sim.model.site_name2id(
            '{}water'.format(self.naming_prefix)
        )
    ...
    def handle_joint(self):
        if self._handle_joint is None:
            self._handle_joint = self.worldbody.find("./body/body/body/joint[@name='{}handle_joint']".format(self.naming_prefix))
    ...
    def water_site(self):
        if self._water_site is None:
            self._water_site = self.worldbody.find("./body/body/body/site[@name='{}water']".format(self.naming_prefix))
