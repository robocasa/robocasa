...
def test_all_objects(config, asset_dir, resets, actions):
    ...
    for cat in object_cats:
        ...
        cat_models = list(filter(lambda x: os.path.exists(os.path.join(x, "model.xml")), cat_models))
        models += cat_models
...
if __name__ == "__main__":
   ...
   parser.add_argument("--environment", type=str, default="KitchenPnP")
   ...
   parser.add_argument(
       "--obj_group", type=str, default=None,
